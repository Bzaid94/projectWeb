...
<div class="container">
    ...
    <form action="account-control?action=insert" method="post" autocomplete="off">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" id="firstLastName" name="firstLastName" class="form-control" placeholder="Apellido"
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" id="dpi" name="dpi" class="form-control" placeholder="dpi" aria-label="dpi"
                   aria-describedby="basic-addon6" width="80%">
        </div>

        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon7">Producto</span>
            <input type="text" id="product" name="product" class="form-control" placeholder="Producto" aria-label="product"
                   aria-describedby="basic-addon6" width="80%">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" id="currency" name="currency" class="form-control" placeholder="Moneda" aria-label="currency"
                   aria-describedby="basic-addon6" width="80%">
        </div>
